...
function HomeAdmin({ darkMode }) {
	...
	// Replace your saveAnnouncement function with this fixed version
					...
					isEditing ? (
						...
						>
							...
							<div className="announcement-actions">
								...
								{announcements[currentAnnouncementIndex].office === userOffice && (
									<>
										<button
				...
				<div className="offices-grid">
					...
					<div className="office-block academics">
						...
						<div className="office-links-grid">
							<Link to="/admin/offices/Admissions Office">Admissions Office</Link>
							<Link to="/admin/offices/Library Office">Library Office</Link>
							<Link to="/admin/offices/Examinations Office">Examinations Office</Link>
							<Link to="/admin/offices/Academic Office">Academic Office</Link>
						</div>
					</div>
					...
					<div className="office-block students">
						...
						<div className="office-links-grid">
							<Link to="/admin/offices/Student Affairs Office">Student Affairs Office</Link>
							<Link to="/admin/offices/Mess Office">Mess Office</Link>
							<Link to="/admin/offices/Hostel Office">Hostel Office</Link>
							<Link to="/admin/offices/Alumni Cell">Alumni Cell</Link>
						</div>
					</div>
					...
					<div className="office-block research">
						...
						<div className="office-links-grid">
							<Link to="/admin/offices/Faculty Portal">Faculty Portal</Link>
							<Link to="/admin/offices/Placement Cell">Placement Cell</Link>
							<Link to="/admin/offices/Outreach Office">Outreach Office</Link>
							<Link to="/admin/offices/Statistical Cell">Statistical Cell</Link>
							<Link to="/admin/offices/R&D Office">R&D Office</Link>
						</div>
					</div>
					...
					<div className="office-block administration">
						...
						<div className="office-links-grid">
							<Link to="/admin/offices/General Administration">General Administration</Link>
							<Link to="/admin/offices/Accounts Office">Accounts Office</Link>
							<Link to="/admin/offices/IT Services Office">IT Services Office</Link>
							<Link to="/admin/offices/Communication Office">Communication Office</Link>
							<Link to="/admin/offices/Engineering Office">Engineering Office</Link>
							<Link to="/admin/offices/HR & Personnel">HR & Personnel</Link>
						</div>
					</div>
				</div>
			</div>
